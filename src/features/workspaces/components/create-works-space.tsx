...
interface CreateWorksSpaceFormProps {
  onCancel?: () => void
}

export const CreateWorksSpaceForm = ({ onCancel }: CreateWorksSpaceFormProps) => {
  const { mutate, isPending, reset} = useCreateWorkspace()
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-between">
              ...
              <Button disabled={isPending} size={"lg"} type="submit">Create Workspace</Button>
            </div>
          </form>
        </Form>
      </CardContent>
